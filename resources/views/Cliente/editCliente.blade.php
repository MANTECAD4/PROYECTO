                ...
                <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <!-- Create Post Form -->
                            <form action="{{ route('cliente.update',$cliente) }}" method="POST" class="row g-3">
                                @csrf <!-- Agrega el token CSRF -->
                                @method('PATCH')
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="{{old('nombre') ?? $cliente->user->name}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Télefono" value="{{old('telefono') ?? $cliente->telefono}}" required>
                                        <label for="telefono">Télefono</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" id="correo" name="correo" placeholder="Correo" value="{{old('correo') ?? $cliente->user->email}}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <input type="date" id="fecha_nac" name="fecha_nac" class="form-control" value="{{old('fecha_nac') ?? $cliente->fecha_nac}}"required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Dirección" value="{{old('direccion') ?? $cliente->direccion}}" required>
