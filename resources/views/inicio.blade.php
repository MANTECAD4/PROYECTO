            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" style="height: 65%; width:65%">
                <div class="carousel-inner ">
                    ...
                    <div class="carousel-item ">
                        <img src="{{asset('assets/img/logo2.png ')}}" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('assets/img/logo3.png')}}" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('assets/img/logo4.png')}}" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{asset('assets/img/logo5.png')}}" class="d-block w-100" alt="...">
                    </div>
                </div>           
